...
function ToolCard({ tool, index }: { tool: typeof tools[0]; index: number }) {
  ...
  return (
    ...
    >
      <div
        className="relative flex flex-col items-center gap-4 rounded-3xl border border-slate-200/70 bg-white/80 backdrop-blur-sm p-6 transition-all duration-500 cursor-default overflow-hidden"
        style={{
          boxShadow: hovered
      ...
      {hovered && (
        <motion.div
          ...
          className="absolute -top-16 left-1/2 -translate-x-1/2 z-30 w-56 rounded-xl bg-[#0F172A] px-3 py-2.5 text-center text-xs text-slate-200 shadow-2xl pointer-events-none"
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* Bottom stat strip */}
        <motion.div
          className="mt-14 flex flex-wrap items-center justify-center gap-x-10 gap-y-4 rounded-3xl border border-slate-200/60 bg-white/60 backdrop-blur-sm px-8 py-6"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-[#0F172A]">Tools Covered</p>
              <p className="text-xs text-slate-500">Hands-on training</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-[#0F172A]">Free Tiers</p>
              <p className="text-xs text-slate-500">All tools usable free</p>
            </div>
          </div>
          <div className="h-8 w-px bg-slate-200 hidden sm:block" />
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-[#0F172A]">No Code Needed</p>
              <p className="text-xs text-slate-500">For 9 of 10 tools</p>
            </div>
          </div>
        </motion.div>
      </div>
