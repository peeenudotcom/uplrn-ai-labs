        ...
        <div className="mx-auto max-w-3xl px-6 py-16 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#25D366] px-6 py-3 text-sm font-semibold text-white hover:bg-[#1eba57] transition-colors"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/[0.03] px-6 py-3 text-sm font-semibold text-gray-300 hover:bg-white/[0.06] hover:text-white transition-colors"
            >
              Contact Form
            </Link>
          </div>
